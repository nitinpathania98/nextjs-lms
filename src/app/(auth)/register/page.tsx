                ...
                <div className="m-2 p-2">
                    <div className="flex justify-between items-center my-2 bg-card p-2 rounded-lg mb-5">
                        <div className="flex items-center">
                            ...
                            <div className="text-textColor text-lg mx-2">Add user</div>
                        </div>
                    ...
                    <form>
                        ...
                        <div className="mt-2 grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label htmlFor="firstName" className="block mb-2 text-sm font-medium text-textColor ">
                                    First name
                                </label>
                                <input
                                    id="firstName"
                            ...
                            <div>
                                <label htmlFor="lastName" className="block mb-2 text-sm font-medium text-textColor ">
                                    Last name
                                </label>
                                <input
                                    id="lastName"
                        ...
                        <div className="mt-2 grid gap-6 mb-6 md:grid-cols-2">
                            <div className="mb-6">
                                <label htmlFor="userPassword" className="block mb-2 text-sm font-medium text-textColor ">
                                    Password
                                </label>
                                <input
                                    id="userPassword"
                        ...
                        <div className="mt-2 grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label htmlFor="shift" className="block mb-2 text-sm font-medium text-textColor">
                                    Shift
                                </label>
                                <select
                                    id="shift"
                        ...
                        <button type="submit" className="flex items-center text-white text-sm text-center bg-themeColor p-2 rounded-lg">
                            <svg
                                stroke="currentColor"
                                fill="none"
                                strokeWidth={2}
